# -*- coding: utf-8 -*-
"""铁1(赤炼) Phase 10 调试：枯魂阴牢 自动遇怪2次→找小男孩→提交→接取"""
...
def auto_battle_phase(count=2):
    print(f"  按键0 开启自动遇怪 (目标{count}场)...")
    tap(KEY0, "键0开启", wait=1.0)
    battles = 0
    t0 = time.time()
...
print("=== 铁1 Phase 10: 枯魂阴牢 遇怪2次→找小男孩→提交→接取 ===")
auto_battle_phase(2)
