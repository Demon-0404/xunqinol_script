# -*- coding: utf-8 -*-
"""铁2(浮游) Phase 0 调试：备忘→副本→OCR找浮游→点行→瞬间传送"""
...
print("=== 铁2 Phase 0: 备忘→副本→OCR找浮游→点行→瞬间传送 ===")
...
pos = find_text(arr, "浮游", 300, 1300) or find_text(arr, "浮", 300, 1300)
if not pos:
    print("!!! 未找到 浮游，请查看上方识别结果")
    sys.exit(1)
cx, cy, text, conf = pos
