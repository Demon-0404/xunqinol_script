# -*- coding: utf-8 -*-
"""铁2(浮游) Phase 3 调试：点(550,20)3次→(700,20)2次，检测进入渴望之境"""
...
POS1 = (550, 200)   # 第一个点击位置
POS2 = (700, 200)   # 第二个点击位置
...
print("=== 铁2 Phase 3: 点(550,200)3次→(700,200)2次，检测渴望之境 ===")
if not walk_phase("位置1(550,200)", POS1, TARGET_KEY, 3):
    walk_phase("位置2(700,200)", POS2, TARGET_KEY, 2)
print("=== Phase 3 完成 ===")
