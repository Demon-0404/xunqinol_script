# -*- coding: utf-8 -*-
"""铁2(浮游) Phase 5 调试：点击画面右上角3次(间隔3s)，检测是否进入新地图"""
...
print("=== 铁2 Phase 5: 点击右上角(1050,200)3次，检测回忆之地 ===")
...
print(f"=== Phase 5 完成 (进入回忆之地: {entered}) ===")
