# -*- coding: utf-8 -*-
"""铁4(魔界之门) Phase 4 调试：左下角3次→左上角3次，检测进入鬼爪炼狱"""
...
print("=== 铁4 Phase 4: 左下角3次→左上角3次，检测鬼爪炼狱 ===")
print(f"  初始地图: '{get_map_name()}'")
if not walk_phase("左下角(30,1100)", LEFT_DOWN, TARGET_KEY, 3):
    walk_phase("左上角(30,400)", LEFT_UP, TARGET_KEY, 3)
print("=== Phase 4 完成 ===")
