# -*- coding: utf-8 -*-
"""Redirect portal destination by modifying VAR bytes in-flight"""
...
with open(os.path.join(script_dir, 'portal_redirect.js'), 'r', encoding='utf-8') as f:
    js_template = f.read()
...
print("[*] 请在同一个地图上走任意一个传送门...", flush=True)
print("[*] 如果重定向成功，你会被传到另一个传送门的目的地！", flush=True)
try:
    for i in range(120):
        time.sleep(1)
