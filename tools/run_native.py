# -*- coding: utf-8 -*-
"""Test calling Cocos2d-x functions directly via NativeFunction."""
...
with open(os.path.join(SCRIPT_DIR, 'call_native.js'), 'r', encoding='utf-8') as f:
    JS = f.read().replace('var BASE = 0x0c074000;', f'var BASE = 0x{base:08x};')
...
print("[*] Check game speed. Ctrl+C to exit.", flush=True)
try:
    time.sleep(300)
